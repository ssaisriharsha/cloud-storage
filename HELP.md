...
* The original package name 'com.ssaisriharsha.cloud-storage' is invalid and this project uses 'com.ssaisriharsha.cloud_storage' instead.
...
```
$ docker run --rm -p 8080:8080 cloud-storage:0.0.1-SNAPSHOT
```
